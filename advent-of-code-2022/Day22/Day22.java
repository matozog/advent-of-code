...
public class Day22 implements Task {
    ...
    public Day22() {
        ...
        String fileLines = fileUtils.getFileLinesAsStringByDelimiter("advent-of-code-2022/day22/input.txt", "\n");
    ...
    Field findNextWrappedField(MapFieldValue mapFieldValue) {
        ...
        switch (mapFieldValue) {
            case RIGHT:
                nextWrappedField = Arrays.stream(map.get(currentField.y)).filter(field -> field.fieldValue != MapFieldValue.NOT_IN_MAP).findFirst().orElseThrow();
                break;
            case LEFT:
