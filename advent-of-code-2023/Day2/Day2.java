...
public class Day2 {
    ...
    public Day2() {
        fileLines = fileUtils.getFileLinesAsStringByDelimiter("advent-of-code-2023/day2/input.txt", "\n");
    ...
    public int resolvePart1() {
        ...
        return gamesList.stream()
                .filter(game -> game.setsList.stream().allMatch(set -> isSetPossibleToPlay(set, amountOfRedCubes, amountOfGreenCubes, amountOfBlueCubes)))
                .map(game -> game.Id)
    ...
    public int resolvePart2() {
        ...
        return gamesList.stream().map(game -> game.minAmountOfBlueCubes * game.minAmountOfGreenCubes * game.minAmountOfRedCubes).reduce(0, Integer::sum);
    }
}
