...
public class Day20 implements Task<Long> {
    FileUtils fileUtils;
    ...
    public Day20() {
        ...
        String fileLines = fileUtils.getFileLinesAsStringByDelimiter("src/main/java/aoc2022/day20/input.txt", "\n");
    ...
    private void mixNode(Node currentNode) {
        int amountOfMoves = currentNode.getValue()
                .abs()
                .mod(new BigInteger(String.valueOf(nodes.size() - 1)))
                .intValue();
    ...
    public Long resolvePart1() {
        ...
        return firstCoordinate.getValue().add(secondCoordinate.getValue()).add(thirdCoordinate.getValue()).longValue();
    }
